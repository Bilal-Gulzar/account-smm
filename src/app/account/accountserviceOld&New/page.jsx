...
export const getAccountserviceOldAndNew = async (page) => {
  // Fetch data from  API
...
export default async function AccountserviceOldAndNew({ searchParams }) {
  let page = parseInt(searchParams.pageno);
  page = !page || page < 1 ? 1 : page;
  const getData = await getAccountserviceOldAndNew(page);
            ...
            <div className="mb-24 mt-4">
              <div className="max-w-[600px] sm:mx-auto gap-3 flex mx-10 flex-col justify-center items-center">
                <h1 className="font-medium text-center text-xl sm:text-2xl">
                  Transform Your Online Presence with Verified Accounts
                </h1>
                <p className="font-light text-sm text-start ">
                  Experience the benefits of verified accounts designed for your
                  online needs. Our selection ensures security and authenticity,
                  enabling you to engage confidently on various platforms. Each
                  account is rigorously verified, protecting you from scams and
                  fake profiles. Streamline your online interactions and elevate
                  your brand with trusted credentials. Gain access to premium
                  features and opportunities that enhance your online presence.
                  With our reliable service, you can focus on what matters
                  most—growing your audience and achieving your goals. Join us
                  today to elevate your online experience!
                </p>
              </div>
