        ...
        >
          ...
          {path.includes("admin") ? (
            ...
            <div className="flex flex-col text-sm text gap-3 py-5  ">
              ...
              <p onClick={Logout} className="hover:bg-[#f5f5f5] cursor-pointer p-2.5">
                Log out
              </p>
              <Link href="/admin/accountPanel">
                <p onClick={()=>setIsTrue(false)} className="hover:bg-[#f5f5f5] p-2.5">Admin</p>
              </Link>
            </div>
          )}
        </section>
