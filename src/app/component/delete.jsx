...
export default function Delete({deleteAccount,prop,id,deleteMenu}) {
  return (
    <section
      className={`min-w-[100%] flex justify-center z-50 items-end sm:items-center min-h-screen fixed top-0 backdrop-blur-sm bg-[#666666]/80 ${
        deleteMenu ? "translate-y-0" : "translate-y-full"
      }`}
    >
      <div
        className={`w-full sm:w-[600px] md:w-[700px] lg:w-[800px]  rounded-t-2xl sm:rounded-xl h-[170px] bg-white  transition-all duration-300 ease-out ${
          deleteMenu ? "translate-y-0" : "translate-y-full"
        }`}
      >
