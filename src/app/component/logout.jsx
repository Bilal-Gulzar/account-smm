...
export default function LogOut() {
  ...
  return (
    ...
    <section className={`${logging ? "" : "translate-y-full"} z-40 fixed justify-center items-end sm:items-center left-0 top-0  backdrop-blur-sm bg-[#666666]/80 w-full h-full flex  `}>
