...
useEffect(() => {
  ...
  return (
    <main className="bg-[#f5f5f5] overflow-hidden min-h-screen">
      ...
      <div className="mt-10 px-5  lg:max-w-[1200px] lg:mx-auto lg:px-14">
        ...
        <div className="grid gap-7 md:gap-5 md:grid-cols-[40%_auto] mt-8">
          ...
          <div className="bg-white lg:flex-row flex-col flex gap-4 lg:items-center p-5 rounded-md ">
            <button onClick={Logout} className="py-4 flex justify-center items-center border-[1.5px] font-medium text-gray-300 text-sm tracking-wide hover:text-gray-400 px-8 border-gray-300 rounded-md">
              Log out everywhere
            </button>
      ...
      <div className="border-t lg:max-w-[1085px] lg:mx-auto px-5  text-xs flex lg:flex-row flex-col items-center  underline gap-7 py-8 fixed bottom-0 right-0 left-0 w-full  border-gray-300 mt-14">
