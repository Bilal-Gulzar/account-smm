      ...
      <section className="overflow-x-hidden  mx-auto pb-28">
        <Link href={"/admin/accountPanel/new"}>
          <div className="sm:w-[36rem] gap-2 mx-5 sm:mx-auto flex mt-14 items-center  justify-center lg:w-[47rem] border py-2.5 px-4 shadow-sm border-gray-300  font-semibold rounded-lg">
            <p className="font-sans font-bold"> Create new Account</p>
            <span>
                      ...
                      .map((x) => (
                        ...
                        >
                          ...
                          <div className="w-full flex justify-between items-center px-2">
                            <p className="font-sans tracking-wide font-medium  px-2 break-words text-base line-clamp-1">
                              {x.accountName}
                            </p>
                          ...
                          <div className="w-full p-2">
                            <Link href={`/admin/accountPanel/${x._id}`}>
                              <button className="bg-black w-full tracking-wider py-2 rounded-md text-white font-medium text-sm">
                                Update Account
                              </button>
                            </Link>
                          </div>
